...
/***/ function(module, exports, __webpack_require__) {
	...
	var _WeightLifting = __webpack_require__(91);
	
	var _WeightLifting2 = _interopRequireDefault(_WeightLifting);
	
	var _HeatMap = __webpack_require__(90);
	
	var _HeatMap2 = _interopRequireDefault(_HeatMap);
	
	var _Running = __webpack_require__(92);
	...
	var _Signin = __webpack_require__(94);
	...
	ReactDOM.render(React.createElement(
	  ...
	  React.createElement(_reactRouter.Route, { path: '/', component: _Dashboard2.default }),
	  React.createElement(_reactRouter.Route, { path: '/lifting', component: _WeightLifting2.default }),
	  React.createElement(_reactRouter.Route, { path: '/running', component: _Running2.default }),
	  React.createElement(_reactRouter.Route, { path: '/heatmap', component: _HeatMap2.default }),
	  React.createElement(_reactRouter.Route, { path: '/signup', component: _Signup2.default }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Dashboard = function (_React$Component) {
	  ...
	  function Dashboard(props) {
	    ...
	    _this.getUsersWorkouts = _this.getUsersWorkouts.bind(_this);
	    _this.completeWorkoutHandler = _this.completeWorkoutHandler.bind(_this);
	    return _this;
	  }
	  ...
	  _createClass(Dashboard, [{
	    ...
	    key: 'completeWorkoutHandler',
	    value: function completeWorkoutHandler() {
	      var didTheThing = {};
	    ...
	    key: 'getUsersWorkouts',
	    value: function getUsersWorkouts() {
	      var that = this;
	      var userId = window.sessionStorage.user;
	    ...
	    value: function render() {
	      ...
	      return React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement(_HeatMap2.default, null),
	          React.createElement(
	            'div',
	            { className: 'row' },
	            this.state.weightLifting.map(function (workout, index) {
	              ...
	              return React.createElement(
	                ...
	                React.createElement(
	                  ...
	                  React.createElement(
	                    ...
	                    React.createElement(
	                      ...
	                      React.createElement(
	                        'tbody',
	                        null,
	                        workout.exercises.map(function (exercise, index) {
	                          return React.createElement(
	                            'tr',
	                            { key: index },
	                            React.createElement(
	                  ...
	                  React.createElement(
	                    'div',
	                    { className: 'panel-footer flex-center' },
	                    React.createElement(
	                      'button',
	                      { type: 'button', className: 'btn btn-default', onClick: _this2.completeWorkoutHandler },
	                      'Complete Workout'
	                    )
	                  )
	                )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Nav = function (_React$Component) {
	  ...
	  _createClass(Nav, [{
	    ...
	    key: 'reRouteAddWorkout',
	    value: function reRouteAddWorkout() {
	      return React.createElement(
	        _reactRouter.Link,
	        { to: '/lifting' },
	        'Add Workout'
	    ...
	    value: function render() {
	      return React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            'nav',
	            { className: 'navbar navbar-default navbar-static purple' },
	            React.createElement(
	              'div',
	              { className: 'navbar-header' },
	              React.createElement('img', { className: 'logo', src: '../../assets/kf.png' })
	            ),
	            React.createElement(
	              'button',
	              { type: 'button', className: 'btn btn-default btn-sm navbutton-left' },
	              this.signOut()
	            ),
	            React.createElement(
	              'button',
	              { type: 'button', className: 'btn btn-default btn-lg navbutton-right' },
	...
	var HeatMap = function (_React$Component) {
	  ...
	  _createClass(HeatMap, [{
	    ...
	    value: function getTimeStamps() {
	      var that = this;
	      var userId = window.sessionStorage.user;
	      $.get('/api/users/' + userId + '/events', function (resp) {
	        if (resp) {
	          var obj = {};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var WeightLifting = function (_React$Component) {
	  _inherits(WeightLifting, _React$Component);
	
	  function WeightLifting(props) {
	    _classCallCheck(this, WeightLifting);
	
	    var _this = _possibleConstructorReturn(this, (WeightLifting.__proto__ || Object.getPrototypeOf(WeightLifting)).call(this, props));
	    ...
	    _this.addWorkout = _this.addWorkout.bind(_this);
	    _this.handleWorkoutChange = _this.handleWorkoutChange.bind(_this);
	    return _this;
	  }
	
	  _createClass(WeightLifting, [{
	    ...
	    value: function addWorkout(e) {
	      ...
	      var userId = window.sessionStorage.user;
	      $.post('api/users/' + userId + '/workouts', newWorkout, function (err, resp) {
	        if (err) {
	              ...
	              React.createElement(
	                ...
	                React.createElement(
	                  ...
	                  React.createElement(
	                    'tbody',
	                    null,
	                    this.state.exercises.map(function (i, k) {
	                      return React.createElement(
	                        'tr',
	                    ...
	                    React.createElement(
	                      ...
	                      React.createElement(
	                        'td',
	                        null,
	                        React.createElement('input', { type: 'number', min: '0', className: 'thin-width', value: this.state.weight, onChange: this.handleWeightChange })
	                      ),
	                      React.createElement(
	                        'td',
	                        null,
	                        React.createElement('input', { type: 'number', min: '0', className: 'thin-width', value: this.state.reps, onChange: this.handleRepChange })
	                      ),
	                      React.createElement(
	                        'td',
	                        null,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Running = function (_React$Component) {
	  _inherits(Running, _React$Component);
	
	  function Running(props) {
	    _classCallCheck(this, Running);
	
	    var _this = _possibleConstructorReturn(this, (Running.__proto__ || Object.getPrototypeOf(Running)).call(this, props));
	  ...
	  _createClass(Running, [{
	    ...
	    value: function handleDistanceChange(e) {
	    ...
	    value: function completeWorkout(e) {
	      ...
	      newWorkout.run = { time: this.state.time, distance: this.state.distance };
	      var userId = window.sessionStorage.user;
	      $.post('/api/users/' + userId + '/workouts', newWorkout, function (err, resp) {
	        if (err) {
	                  ...
	                  React.createElement(
	                    ...
	                    React.createElement(
	                      ...
	                      React.createElement(
	                        'td',
	                        null,
	                        React.createElement('input', { type: 'number', className: 'thin-width', value: this.state.time, onChange: this.handleTimeChange })
	                      ),
	                      React.createElement(
	                        'td',
	                        null,
	                        React.createElement('input', { type: 'number', className: 'thin-width', value: this.state.distance, onChange: this.handleDistanceChange })
	                      )
	                    )
	                  )
	                ),
